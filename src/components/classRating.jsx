      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-[#ffffff] p-6 shadow rounded-lg">
          ...
          <ul className="space-y-4">
            <li className="flex items-center bg-[#f8faff] p-2">
              <FaHeart className="text-2xl text-red-500 mr-4" />
              <span className='font-medium flex items-center'>
                <span className="mr-4">250</span>
                <span>Simplest form of teaching</span>
              </span>
            </li>
            <li className="flex items-center bg-[#f8faff] p-2">
              <FaHeart className="text-2xl text-red-500 mr-4" />
              <span className='font-medium flex items-center'>
                <span className="mr-4">312</span>
