...
import { FaChartLine } from 'react-icons/fa'; // Common icon for both learning outcomes and key features

import videoFile from './videos/fullstack.mp4';
import ClassRating from '../classRating';
import AnalysisforInvestorSyllabus from './Fundamental&TechnicalanalysisforinvestorSyllabus';

const AnalysisforInvestor = () => {
            ...
            <div className="bg-gray-50 text-gray-900">
                ...
                <header className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-10">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <h1 className="text-4xl font-bold mb-2">Fundamental & Technical Analysis for Investors</h1>
                        <p className="md:text-lg text-sm text-gray-300">Master investment analysis step-by-step</p>
                    </div>
                </header>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4 text-gray-800">
                                    <li className="flex items-start">
                                        ...
                                        <p>Master investment analysis step-by-step.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaChartLine className="text-2xl text-blue-600 mr-3" />
                                        <p>Understand and apply fundamental & technical analysis.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaChartLine className="text-2xl text-blue-600 mr-3" />
                                        <p>Develop skills to evaluate company fundamentals and financial health.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaChartLine className="text-2xl text-blue-600 mr-3" />
                                        <p>Learn portfolio management and risk assessment techniques.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="flex flex-col pl-6 md:pl-60 gap-3">
                    <span className="text-xl font-semibold text-yellow-500">Fee: ₹7,200</span>
...
export default AnalysisforInvestor;
