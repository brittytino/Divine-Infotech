  ...
  return (
    <div className="px-6 bg-[#fafafc] md:px-12 md:pl-28 mt-4 md:mt-20 pt-12 md:flex">
      ...
      <div ref={leftRef} className="flex-1">
        <h1 className="text-2xl md:text-5xl md:mt-2 text-black font-semibold" style={{ lineHeight: '1.4' }}>
        ...
        <div className="md:gap-5 gap-3 flex flex-row mt-12 transition-all">
          <button className="bg-[#453fe1] transition-all flex items-center justify-center hover:bg-transparent text-white border border-[#453fe1] hover:text-[#628ce9] py-2 px-4 md:py-3 md:px-6 text-lg md:text-xl font-medium rounded-md">
            <span className="flex md:items-center gap-2">
              Explore Courses <GoArrowUpRight className="text-2xl font-bold" />
            </span>
          </button>
          <button className="rounded-md border transition-all text-[#453fe1] bg-[#efeef3] py-2 px-4 md:py-3 md:px-6 text-lg md:text-xl font-medium hover:border-[#8d6adb]">
            Contact Us
          </button>
        </div>
      </div>
      ...
      {/* Right */}
      <div ref={rightRef} className="flex-1 mt-10 md:mt-5 lg:pl-6 lg:pr-2">
