...
const Hero = () => {
  ...
  <button className="bg-[#453fe1] transition-all flex items-center justify-center hover:bg-transparent text-white border border-[#453fe1] hover:text-[#628ce9] py-2 px-4 md:py-3 md:px-6 text-base md:text-xl font-medium rounded-md">
    <span className="flex items-center gap-2">
      Explore Courses <GoArrowUpRight className="text-xl md:text-2xl font-bold" />
    </span>
  </button>
  <button className="rounded-md border transition-all text-[#453fe1] bg-[#efeef3] py-2 px-4 md:py-3 md:px-6 text-base md:text-xl font-medium hover:border-[#8d6adb]">
    Contact Us
  </button>
</div>
