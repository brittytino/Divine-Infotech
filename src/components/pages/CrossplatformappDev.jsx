            ...
            <div className="bg-gray-50 text-gray-900">
                ...
                <header className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-10">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <h1 className="text-4xl font-bold mb-2">Cross-Platform Mobile Apps with Flutter & React Native</h1>
                        <p className="md:text-lg text-sm text-gray-300">Master the art of building mobile apps using Flutter and React Native</p>
                    </div>
                </header>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4 text-gray-800">
                                    <li className="flex items-start">
                                        ...
                                        <p>Hands-on projects to apply Flutter and React Native development skills.</p>
                                    </li>
                                    <li className="flex items-start">
                ...
                <div className="flex flex-col pl-6 md:pl-60 gap-3">
                    <span className="text-xl font-semibold text-yellow-500">Fee: ₹12,000 (Online)</span>
                    ...
                    < section className="bg-gray-100 py-12">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-start">
                                    {/* Add any additional key feature here */}
                                </li>
                            </ul>
                        </div>
                    </section>
