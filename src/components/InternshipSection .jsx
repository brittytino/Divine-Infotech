...
const InternshipSection = () => {
    ...
    return (
        <section
            ...
            className="bg-gray-100 text-white py-6 md:py-12 lg:py-20 px-4 md:px-8 lg:px-20"
        >
            <div className="container mx-auto text-center">
                <motion.h2
                    ...
                    className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6 lg:mb-8 text-blue-500"
                >
                ...
                <motion.p
                    ...
                    className="text-base md:text-lg lg:text-xl mb-4 md:mb-6 lg:mb-8 text-gray-600"
                >
