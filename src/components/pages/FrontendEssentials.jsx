...
import { FaReact, FaCloud, FaProjectDiagram, FaCode, FaTools, FaServer, FaUsers, FaRegLightbulb, FaGraduationCap, FaFolderOpen, FaHandsHelping, FaRegClock } from 'react-icons/fa';


import videoFile from './videos/FrontendEssential.mp4';
...
const FrontendEssentials = () => {
    ...
    const courseData = {
        mostLiked: [
            { count: 450, text: 'Comprehensive coverage' },
            { count: 210, text: 'Project-based learning' },
            { count: 130, text: 'Practical assignments' },
        ],
        expectationsMet: [
            { label: 'Exceeded', percentage: '80%' },
            { label: 'Yes', percentage: '70%' },
            { label: 'Somewhat', percentage: '15%' },
            { label: 'Not Really', percentage: '2%' },
        ],
    };
            ...
            <div className="bg-gray-50 text-gray-900">
                ...
                <header className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-10">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <h1 className="text-4xl font-bold mb-2">Frontend Development Essentials</h1>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4 text-gray-800">
                                    <li className="flex items-start">
                                        ...
                                        <p>Master HTML, CSS, and JavaScript from basics to advanced.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaGraduationCap className="text-2xl text-blue-600 mr-3" />
                                        <p>Build responsive and interactive web pages.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaHandsHelping className="text-2xl text-blue-600 mr-3" />
                                        <p>Learn CSS frameworks and preprocessors like SASS/SCSS.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaRegClock className="text-2xl text-blue-600 mr-3" />
                                        <p>Implement best practices and coding standards.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaCode className="text-2xl text-blue-600 mr-3" />
                                        <p>Develop a project from scratch to build your portfolio.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <section className="bg-gray-100 py-12 transition-all">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    <FaFolderOpen className="text-2xl text-green-600 mr-4" />
                                    <p>Understand the structure and semantics of HTML documents.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaCode className="text-2xl text-green-600 mr-4" />
                                    <p>Apply CSS to style HTML elements and create layouts.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaReact className="text-2xl text-blue-600 mr-4" />
                                    <p>Use JavaScript to add interactivity to web pages.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaCloud className="text-2xl text-teal-600 mr-4" />
                                    <p>Implement responsive design principles for various devices.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaTools className="text-2xl text-gray-800 mr-4" />
                                    <p>Integrate HTML, CSS, and JavaScript to build dynamic web pages.</p>
                                </li>
                            </ul>
                        </div>
                    </section>
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-start">
                                    ...
                                    <p>In-depth tutorials on HTML, CSS, and JavaScript.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaServer className="text-2xl text-blue-600 mr-4" />
                                    <p>Responsive design techniques for various screen sizes.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaTools className="text-2xl text-blue-600 mr-4" />
                                    <p>Guidance on best practices and coding standards.</p>
                                </li>
                                <li className="flex items-start">
