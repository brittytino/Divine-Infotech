...
import { FaBook, FaJava, FaCodeBranch } from 'react-icons/fa';

import videoFile from './videos/fullstack.mp4';
import ClassRating from '../classRating';
// syllabus 
import JavaBeginnerSyllabus from './JavaBeginnerSyllabus';
            ...
            <div className="bg-gray-50 text-gray-900">
                ...
                <header className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-10">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <h1 className="text-4xl font-bold mb-2">Java Programming for Beginners</h1>
                        <p className="md:text-lg text-sm text-gray-300">Learn Java programming from scratch</p>
                    </div>
                </header>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4 text-gray-800">
                                    <li className="flex items-start">
                                        ...
                                        <p>Master Java programming language fundamentals.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaBook className="text-2xl text-blue-600 mr-3" />
                                        <p>Understand object-oriented programming concepts.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaBook className="text-2xl text-blue-600 mr-3" />
                                        <p>Develop real-world applications using Java.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaBook className="text-2xl text-blue-600 mr-3" />
                                        <p>Learn essential data structures and algorithms.</p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaBook className="text-2xl text-blue-600 mr-3" />
                                        <p>Gain insights into Java development best practices.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <section className="bg-gray-100 py-12 transition-all">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    <FaJava className="text-2xl text-green-600 mr-4" />
                                    <p>Understand and use Java syntax and conventions.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaJava className="text-2xl text-green-600 mr-4" />
                                    <p>Develop applications using object-oriented programming principles.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaJava className="text-2xl text-green-600 mr-4" />
                                    <p>Implement data structures and algorithms in Java.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaJava className="text-2xl text-green-600 mr-4" />
                                    <p>Handle file operations and exceptions efficiently.</p>
                                </li>
                                <li className="flex items-start">
                                    <FaJava className="text-2xl text-green-600 mr-4" />
                                    <p>Create simple graphical user interfaces using Java Swing.</p>
                                </li>
                            </ul>
                        </div>
                    </section>
                ...
                {activeTab === 'keyFeatures' && (
                     ...
                     <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                         ...
                         <ul className="space-y-4">
                             <li className="flex items-start">
                                 <FaCodeBranch className="text-2xl text-blue-600 mr-4" />
                                 <p>Hands-on projects to apply Java programming skills.</p>
                             </li>
                             <li className="flex items-start">
                                 <FaCodeBranch className="text-2xl text-blue-600 mr-4" />
                                 <p>Comprehensive coverage of Java OOP concepts.</p>
                             </li>
                             <li className="flex items-start">
                                 <FaCodeBranch className="text-2xl text-blue-600 mr-4" />
                                 <p>Guidance on implementing data structures and algorithms.</p>
                             </li>
                             <li className="flex items-start">
                                 <FaCodeBranch className="text-2xl text-blue-600 mr-4" />
                                 <p>Insights into industry standards and best practices for Java development.</p>
                             </li>
                             <li className="flex items-start">
                                 <FaCodeBranch className="text-2xl text-blue-600 mr-4" />
