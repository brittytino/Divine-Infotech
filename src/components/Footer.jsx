...
const Footer = () => {
    ...
    const socialLinks = [
        { 
            name: 'Facebook', 
            icon: <FaFacebookSquare className="text-blue-500 hover:text-blue-600 transform hover:scale-110 transition-transform duration-300" />, 
            href: '' 
        },
        { 
            name: 'Instagram', 
    ...
    const usefulLinks = [
        ...
        { name: 'Resume Building', href: '/resume-building' },
    ...
    return (
        <footer id='footer' className="bg-gradient-to-r from-red-700 to-red-600 text-white py-8 px-5 md:pt-20 md:px-20">
            <div className="container mx-auto">
                <div className="flex flex-wrap justify-between lg:justify-evenly">
                    <div className="w-full lg:w-4/12 px-4 mb-8 lg:mb-0">
                        <h4 className="md:text-3xl text-2xl font-semibold text-gray-100 mb-4">Let's keep in touch!</h4>
                        <h5 className="md:text-lg text-sm mb-6 text-gray-300">
                            Find us on any of these platforms, we respond in 1-2 business days.
                        </h5>
                        <a href="mailto:divineinfotech.edu@gmail.com" className="font-medium hover:underline underline-offset-4 decoration-gold-400 hover:cursor-pointer transition-all">
                    ...
                    <div className="flex lg:flex-nowrap flex-row justify-between w-full lg:w-auto px-5 gap-5 lg:gap-20">
                        <div className="w-full lg:w-auto mb-8 lg:mb-0">
                            <span className="block uppercase text-gold-400 text-sm font-semibold mb-2">Useful Links</span>
                            <ul className="list-unstyled">
                                {usefulLinks.map((link, index) => (
                                    <li key={index} className='pt-2'>
                                        <a
                                            href={link.href}
                                            className="text-gray-300 hover:text-white font-semibold block text-sm md:text-base underline-offset-4 transition-colors duration-300 hover:underline"
                                        >
                                            {link.name}
                                        </a>
                                    </li>
                        ...
                        <div className="w-full lg:w-auto">
                            <span className="block uppercase text-gold-400 text-sm font-semibold mb-2">Other Resources</span>
                            <ul className="list-unstyled">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-between">
                    <div className="w-full text-center">
                        <div className="text-sm text-gold-300 font-semibold py-1">
