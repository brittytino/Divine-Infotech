...
import sampleImage from '../images/web sol.png';
  ...
  return (
    <div className="bg-green-50 py-16 px-8 grid grid-cols-1 md:grid-cols-2 items-center">
      ...
      <div className="text-left">
       ...
       <a href="/contact"><button className="bg-blue-600 text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-transparent transition-all border-2 border-blue-600 hover:text-blue-600 ">
          Get a Quote →
        </button></a> 
      </div>
    </div>
