...
const Navbar = () => {
  ...
  const stickyNav = location.pathname.startsWith('/courses') ? 'static' : isSticky ? 'sticky top-0 z-50' : '';
  ...
  return (
    <nav className={`${bgColor} ${stickyNav} rounded-md transition-all duration-300 shadow-md md:mx-20`}>
