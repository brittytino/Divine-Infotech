...
import { FaDatabase, FaNodeJs, FaReact, FaCloud, FaProjectDiagram, FaCode, FaTools, FaServer, FaCheckCircle, FaUsers } from 'react-icons/fa';
        ...
        <div className="bg-gray-200 text-gray-900">
            <div className="bg-gray-50 text-gray-900">
                            ...
                            <div>
                                ...
                                <ul className="space-y-4 text-gray-800">
                                    <li className="flex items-start">
                                        <FaCheckCircle className="text-xl text-blue-600 mr-3" />
                                    ...
                                    <li className="flex items-start">
                                        <FaCheckCircle className="text-xl text-blue-600 mr-3" />
                                        <p>Expert guidance and support. Comprehensive  learning system      </p>
                                    </li>
                                    <li className="flex items-start">
                                        <FaCheckCircle className="text-xl text-blue-600 mr-3" />
                ...
                <div className="flex flex-col pl-6 md:pl-60 gap-3">
                    <span className="text-xl font-semibold text-yellow-500">Fee: ₹5,200 </span>
